...
import com.example.demo.service.RatesProcessing;
...
public class RatesController {
  ...
  public boolean compareRates() throws IOException {
    ...
    boolean result = RatesProcessing.compareResponses(rateEntityNew.getBody(), rateEntityOld.getBody(), fileWrite, "");
  ...
  @PostMapping(value = "/compareWithStructures")
  public String seeAllStructures() throws IOException {
    return ratesService.comparewithGeneratedRateStructures(10, 8);
  }
